      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
         ...
         <div class="nav-item dropdown show">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#portfolio">Promociones</a>
          </li>
          <li class="nav-item">
      ...
      <?php while ($appli=mysqli_fetch_array($app)){?>
        <div class="col-md-4">
         ...
         <img class="img-fluid d-block mx-auto" src="img/logotipo.png" alt="">
          ...
          <h4 class="service-heading"><?php echo $appli['nombre_app'] ?></h4>
          <p class="text-muted" align="justify"><?php echo $appli['desc_app'] ?></p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">FIRST PAGE</h3>
        </div>
      </div>
      <div class="row">
